...
const definitions: DefinitionInput[] = [
  ...
  { id: 4, key: 'right_up_two_one', name: '右上2目一度', width: 1, height: 1, consumes: 2, produces: 1, category: 'decrease', standardStatus: 'jis', standardReference: 'JIS 2040' },
  { id: 5, key: 'left_up_two_one', name: '左上2目一度', width: 1, height: 1, consumes: 2, produces: 1, category: 'decrease', standardStatus: 'jis', standardReference: 'JIS 2050' },
  { id: 6, key: 'purl_left_up_two_one', name: '裏目の左上2目一度', width: 1, height: 1, consumes: 2, produces: 1, category: 'decrease', standardStatus: 'jis-derived', standardReference: 'JIS 2050・備考2' },
  ...
  { id: 15, key: 'middle_up_three_one', name: '中上3目一度', width: 1, height: 1, consumes: 3, produces: 1, category: 'decrease', standardStatus: 'jis', standardReference: 'JIS 2060' },
  { id: 16, key: 'right_up_three_one', name: '右上3目一度', width: 1, height: 1, consumes: 3, produces: 1, category: 'decrease', standardStatus: 'jis', standardReference: 'JIS 2070' },
  { id: 17, key: 'left_up_three_one', name: '左上3目一度', width: 1, height: 1, consumes: 3, produces: 1, category: 'decrease', standardStatus: 'jis', standardReference: 'JIS 2080' },
  ...
  { id: 22, key: 'slip_stitch', name: 'すべり目', width: 1, height: 1, consumes: 1, produces: 1, category: 'basic', standardStatus: 'jis', standardReference: 'JIS 2160' },
